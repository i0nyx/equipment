...
INSERT INTO `user` (`id`, `email`, `name`, `password`, `cabinetNumber`, `firstName`, `lastName`, `phoneNumber`, `position`)
VALUES
  (1, NULL, NULL, '$2a$10$GL4zbbMwzF9UHif1lOvh6uioKf7OHtAR37zCs28qaw62rJUXVmBd2', '209', 'Сергей', 'Бузук', '9944882',
   'Оператор ЭВМ');
