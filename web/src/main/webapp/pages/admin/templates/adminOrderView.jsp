    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
               aria-controls="nav-home" aria-selected="true" style="color:black">В обработке</a>
            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
               aria-controls="nav-profile" aria-selected="false" style="color:black">История</a>
            <a class="nav-item nav-link" id="nav-form-order-tab" data-toggle="tab" href="#nav-form-order" role="tab"
               aria-controls="nav-order" aria-selected="true" style="color:black">Оформить</a>
        </div>
    </nav>
            ...
            <table class="table table-striped">
                ...
                <c:forEach var="order" items="${orders}">
                    <tr>
                        ...
                        <td>
                            <button type="button" class="order_success btn-success" value="${order.id}">Выполнен
                            </button>
                        </td>
                    </tr>
                </c:forEach>
        ...
        <div class="tab-pane fade" id="nav-form-order" role="tabpanel" aria-labelledby="nav-form-order-tab">
            ...
            <form id="order_form">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Можно оставить поле пустым или укажите фамилию для кого
                        заказывается запчасть.
                    </small>
                </div>
                <div class="form-group">
