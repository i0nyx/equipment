...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist" >
        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true" style="color:black">В ремонте</a>
    ...
    <div class="tab-pane fade show" id="nav-form" role="tabpanel" aria-labelledby="nav-form-tab">
        ...
        <form class="form-horizontal" id="formReceivedRepair">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="whose" placeholder="Enter whose or cabinet number" required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="control-label" id="number_error" style="display: none; color:red; font-size:10px;">
