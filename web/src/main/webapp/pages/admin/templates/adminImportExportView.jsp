                    ...
                    <tr>
                        ...
                        <td>
                            <form id="importEquipment" method="post" enctype="multipart/form-data">
                                <input type="file" name="file" id="equipmentFile" multiple accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                                <button class="import-equipment-button btn btn-primary btn-xs" >Импорт</button>
                            </form>
                            <div style="display:none;" id="msgSuccess"></div>
                        </td>
                        <td><button class="export-equipment-button btn btn-primary btn-xs" value="download-equipment">Экспорт</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
