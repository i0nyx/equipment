...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist" >
        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true" style="color:black">Оборудование</a>
        <a class="nav-item nav-link" id="nav-form-tab" data-toggle="tab" href="#nav-form" role="tab" aria-controls="nav-form" aria-selected="false" style="color:black">Добавить</a>
    </div>
</nav>
        ...
        <table class="table table-striped">
            ...
            <c:forEach var="equipment" items="${equipments}">
                <tr>
                    ...
                    <td><button type="button" class="equipment_delete btn-danger" value="${equipment.id}">Удалить</button> </td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
    ...
    <div class="tab-pane fade" id="nav-form" role="tabpanel" aria-labelledby="nav-form-tab">
        ...
        <form class="form-horizontal" id="formEquipment">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="code" value="УОНГАК" placeholder="Enter number (уонгак000001)" required>
                </div>
            </div>
            <div class="form-group">
